...
/***/ function(module, exports, __webpack_require__) {
	...
	var EXAMPLES = [__webpack_require__(189), __webpack_require__(190), __webpack_require__(191), __webpack_require__(192), __webpack_require__(199), __webpack_require__(200), __webpack_require__(201)];
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function renderList() {
	      ...
	      var examples = EXAMPLES.map(function (example) {
	        ...
	        return React.createElement(
	          TouchableOpacity,
	          { key: i, onPress: function () {
	              return _this.setState({ example: example });
	            } },
	          React.createElement(
	            View,
	            { style: styles.button },
	    ...
	    value: function renderExample() {
	      ...
	      var _state$example = this.state.example;
	      var title = _state$example.title;
	      var description = _state$example.description;
	      var examples = _state$example.examples;
	
	      var examplesElements = [];
	
	      for (var i = 0; i < examples.length; i++) {
	        var example = examples[i];
	        examplesElements.push(React.createElement(
	          View,
	          { key: i, style: styles.example },
	          React.createElement(
	            Text,
	            { style: styles.title },
	            example.title
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          TouchableOpacity,
	          { onPress: function () {
	              return _this2.setState({ example: null });
	            } },
	          React.createElement(
	            View,
	            { style: styles.header },
	            React.createElement(
	              Text,
	              { style: [styles.white, styles.title] },
	              title
	            ),
	            React.createElement(
	              Text,
	              { style: [styles.white, styles.description] },
	              description
	            )
	          )
	        ),
	...
	AppRegistry.registerComponent('uiexplorer', function () {
	  return App;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// classes polyfills
	React.StyleSheet = __webpack_require__(159);
	React.AppRegistry = __webpack_require__(160);
	React.PixelRatio = __webpack_require__(161);
	
	// components polyfills
	React.View = __webpack_require__(162);
	React.Text = __webpack_require__(180);
	React.Image = __webpack_require__(183);
	React.TextInput = __webpack_require__(184);
	React.ScrollView = __webpack_require__(185);
	
	React.TouchableWithoutFeedback = __webpack_require__(186);
	React.TouchableHighlight = __webpack_require__(186);
	React.TouchableOpacity = __webpack_require__(187);
	...
	for (var i = 0; i < notPortedYetComponents.length; i++) {
	  React[notPortedYetComponents[i]] = __webpack_require__(188);
	}
	...
	var StyleSheet = (function () {
	  ...
	  _createClass(StyleSheet, null, [{
	    ...
	    value: function create(style) {
	      // TODO: I heard that a object.deepFreeze could improve performance.
	      return style;
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppRegistry = (function () {
	  ...
	  _createClass(AppRegistry, null, [{
	    ...
	    value: function registerComponent(name, fn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fixOldFlexbox = __webpack_require__(179);
	...
	var View = (function (_React$Component) {
	  ...
	  _createClass(View, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['pointerEvents']);
	      ...
	      return React.createElement(
	        'div',
	        { className: classNames.join(' '), style: browserifyStyle(this.props.style) },
	        this.props.children
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Enhancer = __webpack_require__(164);
	
	module.exports = function (ComposedComponent) {
	  return Enhancer(ComposedComponent);
	};
	module.exports.Style = __webpack_require__(174);
	module.exports.PrintStyleSheet = __webpack_require__(176);
	module.exports.getState = __webpack_require__(167);
	module.exports.keyframes = __webpack_require__(177);
	module.exports.Config = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var resolveStyles = __webpack_require__(165);
	var printStyles = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MouseUpListener = __webpack_require__(166);
	var getState = __webpack_require__(167);
	var getStateKey = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createMarkupForStyles = __webpack_require__(175);
	var Prefixer = __webpack_require__(169);
...
/***/ function(module, exports) {
	...
	function browserifyStyle() {
	  ...
	  var propsThatNeedsPx = ['borderRadius', 'borderTopLeftRadius', 'borderTopRightRadius', 'borderBottomLeftRadius', 'borderBottomRightRadius', 'borderWidth', 'borderTopWidth', 'borderBottomWidth', 'borderLeftWidth', 'borderRightWidth', 'bottom', 'height', 'left', 'margin', 'marginBottom', 'marginTop', 'marginLeft', 'marginRight', 'marginHorizontal', 'marginVertical', 'padding', 'paddingVertical', 'paddingHorizontal', 'paddingTop', 'paddingBottom', 'paddingLeft', 'paddingRight', 'right', 'shadowRadius', 'top', 'width', 'fontSize', 'lineHeight'];
	  // Property that has Vertical and Horizontal properties that does'nt exists on the web
	  var doubleDirectionProps = ['padding', 'margin'];
	  ...
	  for (var i = 0; i < doubleDirectionProps.length; i++) {
	    ...
	    if (typeof style[prop + 'Horizontal'] !== 'undefined') {
	      style[prop + 'Left'] = typeof style[prop + 'Left'] === 'undefined' ? style[prop + 'Horizontal'] : style[prop + 'Left'];
	      style[prop + 'Right'] = typeof style[prop + 'Right'] === 'undefined' ? style[prop + 'Horizontal'] : style[prop + 'Right'];
	    ...
	    if (typeof style[prop + 'Vertical'] !== 'undefined') {
	      style[prop + 'Top'] = typeof style[prop + 'Top'] === 'undefined' ? style[prop + 'Vertical'] : style[prop + 'Top'];
	      style[prop + 'Bottom'] = typeof style[prop + 'Bottom'] === 'undefined' ? style[prop + 'Vertical'] : style[prop + 'Bottom'];
	      // delete from the style (TODO: maybe we should object.assign the stype to another style to avoid object modifications?)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (SuperComponent) {
	  var FlexboxFix = (function (_React$Component) {
	    _inherits(FlexboxFix, _React$Component);
	
	    function FlexboxFix() {
	      _classCallCheck(this, FlexboxFix);
	
	      _get(Object.getPrototypeOf(FlexboxFix.prototype), 'constructor', this).apply(this, arguments);
	    }
	
	    _createClass(FlexboxFix, [{
	      key: 'render',
	      value: function render() {
	        // deconstruct style
	        ...
	        */
	        ...
	        if (!IE10 || !style) return React.createElement(SuperComponent, this.props);
	
	        // returns a cloned element
	        return React.createElement(SuperComponent, _extends({}, this.props, { style: [{ maxWidth: '100%' }].concat(style) }));
	      }
	    }]);
	...
	var Text = (function (_React$Component) {
	  ...
	  _createClass(Text, [{
	    ...
	    value: function render() {
	      ...
	      var suppressHighlighting = this.props.suppressHighlighting;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (window, document, exportName, undefined) {
	    ...
	    if ("function" == TYPE_FUNCTION && __webpack_require__(182)) {
	        !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
	            return Hammer;
	        }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    } else if (typeof module != 'undefined' && module.exports) {
	...
	var Image = (function (_React$Component) {
	  ...
	  _createClass(Image, [{
	    ...
	    value: function render() {
	      ...
	      var uri = _props.source.uri;
	
	      var props = _objectWithoutProperties(_props, ['resizeMode', 'backgroundImage', 'source']);
	      ...
	      return React.createElement(
	        'div',
	        { className: 'image', style: browserifyStyle(style, props.style) },
	        props.children
	      );
	    }
	  }]);
	...
	var TextInput = (function (_React$Component) {
	  ...
	  _createClass(TextInput, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['defaultValue', 'value', 'placeholder', 'multiline', 'secureTextEntry', 'textAlign', 'style']);
	  ...
	  _createClass(ScrollView, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          View,
	          { style: browserifyStyle(this.props.contentContainerStyle) },
	          this.props.children
	        )
	      );
	    }
	  ...
	  _createClass(TouchableWithoutFeedback, [{
	    ...
	    value: function onMouseUp(e) {
	      ...
	      setTimeout(function () {
	        ...
	        if (_this2.props.onPress) _this2.props.onPress(e);
	      }, delayPressOut);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var TouchableWithoutFeedback = __webpack_require__(186);
	var View = __webpack_require__(162);
	var Hammer = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotPortedYet = (function (_React$Component) {
	  _inherits(NotPortedYet, _React$Component);
	
	  function NotPortedYet() {
	    _classCallCheck(this, NotPortedYet);
	
	    _get(Object.getPrototypeOf(NotPortedYet.prototype), 'constructor', this).apply(this, arguments);
	  }
	
	  _createClass(NotPortedYet, [{
	    key: 'render',
	    value: function render() {
	      return React.createElement(
	        'div',
	        { className: 'view', style: browserifyStyle(styles.main, this.props.style) },
	        this.props.children,
	        React.createElement(
	          'div',
	          { style: browserifyStyle(styles.overlay) },
	          'NotPortedYet!'
	        )
	      );
	    }
	...
	exports.examples = [{
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        View,
	        { style: { flexDirection: 'row', position: 'absolute', height: 80 } },
	      ...
	      React.createElement(
	        Text,
	        { style: [styles.backgroundColorText, { marginBottom: 5, containerBackgroundColor: 'transparent' }] },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageCapInsetsExample = __webpack_require__(193);
	...
	exports.examples = [{
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(Image, {
	        style: [styles.base, styles.background, styles.leftMargin, { borderRadius: 19 }],
	        source: smallImage
	      })
	    );
	  }
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      { style: styles.horizontal },
	      React.createElement(Image, {
	        source: __webpack_require__(195),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageCapInsetsExample = React.createClass({
	  displayName: 'ImageCapInsetsExample',
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(Image, {
	          source: __webpack_require__(194),
	      ...
	      React.createElement(
	        View,
	        { style: [styles.background, { paddingTop: 10 }] },
	        React.createElement(
	          Text,
	          null,
	          'capInsets: 15'
...
/***/ }
/******/ ]);
//# sourceMappingURL=bundle.web.map