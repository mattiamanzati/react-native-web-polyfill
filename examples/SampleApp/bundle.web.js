...
/***/ function(module, exports, __webpack_require__) {
	...
	// classes polyfills
	React.StyleSheet = __webpack_require__(10);
	React.AppRegistry = __webpack_require__(11);
	
	// components polyfills
	React.View = __webpack_require__(4);
	React.Text = __webpack_require__(5);
	React.Image = __webpack_require__(6);
	React.TextInput = __webpack_require__(3);
	React.ScrollView = __webpack_require__(7);
	
	React.TouchableWithoutFeedback = __webpack_require__(8);
	React.TouchableHighlight = __webpack_require__(8);
	React.TouchableOpacity = __webpack_require__(8);
	...
	for (var i = 0; i < notPortedYetComponents.length; i++) {
	  React[notPortedYetComponents[i]] = __webpack_require__(9);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var browserifyStyle = __webpack_require__(13);
	var fixOldFlexbox = __webpack_require__(14);
	    ...
	    _createClass(View, [{
	        ...
	        value: function render() {
	            return React.createElement(
	                'div',
	                { className: 'view', style: browserifyStyle(this.props.style) },
	                this.props.children
	            );
	        }
	    }]);
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        { onClick: function (e) {
	          ...
	          }, className: 'text', style: browserifyStyle(this.props.style) },
	        this.props.children
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Image = (function (_React$Component) {
	  ...
	  _createClass(Image, [{
	    key: 'render',
	    value: function render() {
	      var backgroundSize = typeof this.props.resizeMode === 'undefined' ? 'cover' : this.props.resizeMode;
	
	      var backgroundImage = typeof this.props.source === 'undefined' ? 'none' : 'url(' + this.props.source.uri + ')';
	      ...
	      return React.createElement(
	        'div',
	        { className: 'image', style: browserifyStyle(style, this.props.style) },
	        this.props.children
	      );
	    }
	  }]);
	...
	var ScrollView = (function (_React$Component) {
	  ...
	  _createClass(ScrollView, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        'div',
	        { className: 'scroll-view', style: browserifyStyle(this.props.style) },
	        React.createElement(
	          View,
	  ...
	  _createClass(TouchableWithoutFeedback, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        { onClick: function (e) {
	            return _this.onClick(e);
	          }, className: 'touchable-without-feedback', style: browserifyStyle(this.props.style) },
	        this.props.children
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// WIP: this module will apply max-width: 100% on flex-direction: column parents
	'use strict';
	    ...
	    _createClass(FlexboxFix, [{
	      ...
	      value: function render() {
	        ...
	        for (var i = 0; i < style.length; i++) {
	          computedStyle = _extends({}, computedStyle, style[i]);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getStateKey = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var resolveStyles = __webpack_require__(46);
	var printStyles = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createMarkupForStyles = __webpack_require__(48);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MouseUpListener = __webpack_require__(115);
	var getState = __webpack_require__(17);
	var getStateKey = __webpack_require__(45);
	var Prefixer = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExecutionEnvironment = __webpack_require__(114);
	var arrayFind = __webpack_require__(159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	AppRegistry.registerComponent('SampleApp', function () {
	  return SampleApp;
	});
